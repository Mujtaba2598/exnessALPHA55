...
console.log('📦 Version: 66.0.0 - DIAGNOSTIC FIXED');
console.log('✅ AI DIAGNOSTIC ENGINE FULLY WORKING');
console.log('✅ BALANCE DETECTION WORKING');
console.log('✅ TRADING ENGINE WORKING');
        ...
        try {
            ...
            if (tradingCheck.warnings) {
                tradingCheck.warnings.forEach(w => {
                    ...
                    healthScore -= 5;
                    fixes.push({ component: 'trading', action: 'restart_trading', description: 'Restart trading' });
                });
            }
        } catch (e) {
    ...
    async checkBalance() {
        ...
        try {
            ...
            for (const [email, userData] of Object.entries(users)) {
                ...
                if (userData.lastBalance === 0 && userData.lastBalanceUpdate) {
                    balanceError = 'Balance is 0';
                }
            }
            ...
            if (hasBalance) {
                ...
                result.status = 'warning';
                result.warnings.push(balanceError || 'No balance detected. Please connect Exness account.');
            }
        ...
        try {
            switch (fix.action) {
                ...
                case 'refresh_balance':
                    ...
                    success = refreshed > 0;
                    message = refreshed > 0 ? `Balance refreshed for ${refreshed} accounts` : 'No balance found to refresh';
                    break;
